...
> **文档定位**：面向"社区生鲜中央仓/分拣/净菜/冷链"产线装配仿真的工业级工程方案，从场景理解、技术选型到部署上线的完整落地路径，可直接用于生产环境实施，也可作为项目技术评审与面试深挖的支撑材料。
>
...
*本方案与简历 `resume_threejs.html` 技术口径完全一致，可直接作为该项目的前置技术方案、技术评审材料或面试"项目深挖"的结构化应答框架。*

*关联速记：`04-干涉分析`、`05-模型轻量化与Web3D技术点`。*
